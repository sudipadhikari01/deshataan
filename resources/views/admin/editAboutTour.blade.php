...
<div class="container-fluid">
    ...
    <div class="col-xl-12">
    <form method="POST" action="{{url("/adminn/editAboutTour/$iaboutTour->id")}}" enctype="multipart/form-data"  >
        {{ csrf_field() }}
                ...
                <div class="basic-form">
                        ...
                        <div class="form-group row align-items-center">
                            ...
                            <div class="col-sm-9">
                                ...
                                <input type="text" class="form-control" id="validationDefaultUsername1"  placeholder="Enter places covered"  name="placesCovered" value="{{$iaboutTour->places_covered}}">
                                </div>
                            </div>
                        </div>
                        <div class="form-group row align-items-center">
                            ...
                            <div class="col-sm-9">
                                <div class="input-group">
                                    <input type="text" class="form-control" id="validationDefaultUsername2" placeholder="Enter inclusions" name="inclusions" value="{{$iaboutTour->inclusions}}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group row align-items-center">
                            ...
                            <div class="col-sm-9">
                                <div class="input-group">
                                    <input type="text" class="form-control" id="validationDefaultUsername2" placeholder="Enter exclusions" name="exclusions" value="{{$iaboutTour->exclusions}}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group row align-items-center">
                            ...
                            <div class="col-sm-9">
                                <div class="input-group">
                                    <input type="date" class="form-control" id="datePicker1" placeholder="Enter event date" name="eventDate" value="{{$iaboutTour->event_date}}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group row align-items-center">
                            ...
                            <div class="col-sm-9">
                                <select name="packageType" class="form-control">
                                     <option value="{{PagesController::showPackageType($iaboutTour->p_id)}}">Choose Package Type</option>
