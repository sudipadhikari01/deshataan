...
<div class="container-fluid">
    ...
    <div class="col-xl-12">
    <form method="POST" action="{{url("/adminn/editPhoto/$individualPhoto->id")}}" enctype="multipart/form-data"  >
        {{ csrf_field() }}
                ...
                <div class="basic-form">
                        ...
                        <div class="form-group row align-items-center">
                            ...
                            <div class="col-sm-9">
                                ...
                                <input type="text" class="form-control" id="validationDefaultUsername1"  placeholder="Enter image title"  name="imageTitle" value="{{$individualPhoto->image_title}}">
                                </div>
                            </div>
                        </div>
                        <div class="form-group row align-items-center">
                            ...
                            <div class="col-sm-9">
                                <div class="input-group">
                                    <input type="file" class="form-control" id="" aria-describedby="inputGroupPrepend2" name="image"value="{{$individualPhoto->image_name}}">
                                </div>
                            </div>
                        </div>
