...
<div class="container-fluid">
    ...
    <div class="col-xl-12">
    <form method="POST" action="{{url("/adminn/editHotelsPhoto/$hotelPhotos->id")}}" enctype="multipart/form-data"  >
        {{ csrf_field() }}
                ...
                <div class="basic-form">
                        ...
                        <div class="form-group row align-items-center">
                            ...
                            <div class="col-sm-9">
                                ...
                                <input type="text" class="form-control" id="validationDefaultUsername1"   name="imageTitle" value="{{$hotelPhotos->title}}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group row align-items-center">
                            ...
                            <div class="col-sm-9">
                                <div class="input-group">
                                    <input type="text" class="form-control" id="validationDefaultUsername1"   name="imageDesc"  value="{{$hotelPhotos->description}}">
                                </div>
                            </div>
                        </div>
                        <div class="form-group row align-items-center">
