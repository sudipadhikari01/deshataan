...
<div class="container-fluid">
    ...
    <div class="col-xl-12">
    <form method="POST" action="{{url('/adminn/addHotelsPhoto')}}" enctype="multipart/form-data"  >
        {{ csrf_field() }}
            ...
            <div class="card-body">
                ...
                <div class="basic-form">
                        ...
                        <div class="form-group row align-items-center">
                            ...
                            <div class="col-sm-9">
                                <div class="input-group">
                                    <input type="text" class="form-control" id="validationDefaultUsername1"  placeholder="Enter image description" aria-describedby="validationDefaultUsername1" name="imageDesc">
                                </div>
                            </div>
                        </div>
                        <div class="form-group row align-items-center">
