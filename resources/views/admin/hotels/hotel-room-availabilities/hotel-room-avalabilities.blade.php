    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                ...
                <a href="{{url('/adminn/addHotelRoomAvai')}}" class="mr-4" data-toggle="tooltip" data-placement="top" title="Add hotel room availabilities"><i class="fas fa-upload"></i></a>
                </div>
                        ...
                        <tbody>
                            <tr>
                               ...
                               <td>{{$hotel_room_availabilitie->title}}</td>
                                ...
                                <td><span><a href="{{url("/adminn/editHotelRoomAvai/$hotel_room_availabilitie->id")}}" class="mr-4" data-toggle="tooltip" data-placement="top" title="Edit"><i class="fas fa-edit"></i></a>
                                <a href="{{url("/adminn/deleteHotelRoomAvai/$hotel_room_availabilitie->id")}}" class="mr-4" data-toggle="tooltip" data-placement="top" title="Delete"  onclick="del()"><i class="fa fa-trash color-danger" aria-hidden="true"  id="deletePackage"></i></a> 
                                </span>
                                </td>
                            </tr>
